...
export const demoTasks: Task[] = [
  // Pháp lý (Legal)
  { id: 't1', project_id: '1', title: 'Xin giấy phép xây dựng', phase: 'Legal', module: 'legal', zone: 'All', owner: 'Phòng pháp chế', priority: 'High', kanban_status: 'Done', planned_start: '2026-06-01', planned_end: '2026-06-15', actual_start: '2026-06-01', actual_end: '2026-06-14', progress_pct: 100, due_date: '2026-06-15', constraint_note: null, notes: 'Đã nhận GPXD số 123/GPXD' },
  { id: 't2', project_id: '1', title: 'Phê duyệt PCCC', phase: 'Legal', module: 'legal', zone: 'All', owner: 'Phòng pháp chế', priority: 'High', kanban_status: 'In Progress', planned_start: '2026-06-16', planned_end: '2026-07-10', actual_start: '2026-06-17', actual_end: null, progress_pct: 60, due_date: '2026-07-10', constraint_note: 'Chờ cơ quan PCCC duyệt hồ sơ', notes: null },

  // Thiết kế (Design)
  { id: 't3', project_id: '1', title: 'Bản vẽ thi công (Shop drawings)', phase: 'Design', module: 'design', zone: 'All', owner: 'KTS. Nguyễn Văn A', priority: 'High', kanban_status: 'Done', planned_start: '2026-06-01', planned_end: '2026-06-20', actual_start: '2026-06-02', actual_end: '2026-06-19', progress_pct: 100, due_date: '2026-06-20', constraint_note: null, notes: 'Đã ký duyệt' },
  { id: 't4', project_id: '1', title: 'Mock-up phòng khách sạn', phase: 'Design', module: 'design', zone: 'Floor 12', owner: 'KTS. Nguyễn Văn A', priority: 'Medium', kanban_status: 'Review', planned_start: '2026-06-21', planned_end: '2026-07-05', actual_start: '2026-06-22', actual_end: null, progress_pct: 90, due_date: '2026-07-05', constraint_note: null, notes: 'Chờ chủ đầu tư confirm' },

  // Cung ứng-Đấu thầu (Procurement)
  { id: 't5', project_id: '1', title: 'Đấu thầu gói MEP', phase: 'Procurement', module: 'procurement', zone: 'All', owner: 'Phòng mua hàng', priority: 'High', kanban_status: 'Done', planned_start: '2026-06-05', planned_end: '2026-06-25', actual_start: '2026-06-05', actual_end: '2026-06-24', progress_pct: 100, due_date: '2026-06-25', constraint_note: null, notes: 'Trúng thầu: Công ty MEP Việt' },
  { id: 't6', project_id: '1', title: 'Đặt hàng vật tư nội thất (Furniture)', phase: 'Procurement', module: 'procurement', zone: 'All', owner: 'Phòng mua hàng', priority: 'Medium', kanban_status: 'In Progress', planned_start: '2026-06-26', planned_end: '2026-08-15', actual_start: '2026-06-28', actual_end: null, progress_pct: 30, due_date: '2026-08-15', constraint_note: 'Lead time 8 tuần từ Ý', notes: null },

  // Thi công (Construction)
  { id: 't7', project_id: '1', title: 'Demo & dọn mặt bằng', phase: 'Construction', module: 'construction', zone: 'Lobby', owner: 'Đội A', priority: 'High', kanban_status: 'Done', planned_start: '2026-06-01', planned_end: '2026-06-10', actual_start: '2026-06-01', actual_end: '2026-06-09', progress_pct: 100, due_date: '2026-06-10', constraint_note: null, notes: null },
  { id: 't8', project_id: '1', title: 'MEP rough-in', phase: 'Construction', module: 'construction', zone: 'Floor 2', owner: 'Đội B', priority: 'High', kanban_status: 'In Progress', planned_start: '2026-06-11', planned_end: '2026-07-05', actual_start: '2026-06-12', actual_end: null, progress_pct: 45, due_date: '2026-07-05', constraint_note: 'Chờ vật tư ống đồng', notes: null },
  { id: 't9', project_id: '1', title: 'Drywall partition', phase: 'Construction', module: 'construction', zone: 'Floor 2', owner: 'Đội C', priority: 'Medium', kanban_status: 'To Do', planned_start: '2026-07-06', planned_end: '2026-07-20', actual_start: null, actual_end: null, progress_pct: 0, due_date: '2026-07-20', constraint_note: null, notes: null },
  { id: 't10', project_id: '1', title: 'Nghiệm thu PCCC', phase: 'Inspection', module: 'construction', zone: 'All', owner: 'QA', priority: 'High', kanban_status: 'Review', planned_start: '2026-06-20', planned_end: '2026-06-28', actual_start: '2026-06-21', actual_end: null, progress_pct: 80, due_date: '2026-06-28', constraint_note: 'Chờ lịch cơ quan PCCC', notes: null },

  // Sales & marketing
  { id: 't11', project_id: '1', title: 'Booking website & launch campaign', phase: 'Sales', module: 'sales', zone: 'All', owner: 'Marketing team', priority: 'Medium', kanban_status: 'To Do', planned_start: '2026-09-01', planned_end: '2026-10-15', actual_start: null, actual_end: null, progress_pct: 0, due_date: '2026-10-15', constraint_note: null, notes: 'Soft launch Q4' },
  { id: 't12', project_id: '1', title: 'Press release & KOL tour', phase: 'Marketing', module: 'sales', zone: 'All', owner: 'Marketing team', priority: 'Low', kanban_status: 'To Do', planned_start: '2026-11-01', planned_end: '2026-12-01', actual_start: null, actual_end: null, progress_pct: 0, due_date: '2026-12-01', constraint_note: null, notes: null },
];
