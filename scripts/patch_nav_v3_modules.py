...
TRANSLATIONS = {
    "nav.daily_diary": {
        ...
        "es": "Diario de obra",
        "it": "Giornale di cantiere",
        "pt": "Diário de obra",
        "ru": "Журнал стройплощадки",
        "zh": "施工日志",
        "ja": "工事日報",
        "ko": "현장 일지",
        "ar": "يوميات الموقع",
        "hi": "दैनिक डायरी",
        "th": "บันทึกประจำวัน",
        "vi": "Nhật ký công trường",
        "id": "Buku Harian Proyek",
        "tr": "Şantiye Günlüğü",
        "nl": "Bouwdagboek",
        "pl": "Dziennik budowy",
        "cs": "Stavební deník",
        ...
        "da": "Byggedagbog",
        "fi": "Työmaapäiväkirja",
        "ro": "Jurnal de șantier",
        "bg": "Дневник на обекта",
        "hr": "Dnevnik gradilišta",
    },
    "nav.equipment": {
        "de": "Geräte & Fuhrpark",
        "fr": "Équipement & flotte",
        "es": "Equipos y flota",
        "it": "Attrezzature e flotta",
        "pt": "Equipamentos e frota",
        "ru": "Оборудование и автопарк",
        "zh": "设备与车队",
        "ja": "機材・車両",
        "ko": "장비 및 차량",
        "ar": "المعدات والأسطول",
        "hi": "उपकरण और बेड़ा",
        "th": "อุปกรณ์และยานพาหนะ",
        "vi": "Thiết bị & phương tiện",
        "id": "Peralatan & Armada",
        "tr": "Ekipman ve Filo",
        "nl": "Materieel & wagenpark",
        "pl": "Sprzęt i flota",
        "cs": "Vybavení a vozový park",
        "sv": "Utrustning & fordon",
        "no": "Utstyr og flåte",
        "da": "Udstyr og flåde",
        "fi": "Kalusto ja laitteet",
        "ro": "Echipamente și flotă",
        "bg": "Оборудване и автопарк",
        "hr": "Oprema i vozni park",
    },
    "nav.resources": {
        "de": "Ressourcen & Personal",
        "fr": "Ressources & équipes",
        "es": "Recursos y personal",
        "it": "Risorse e personale",
        "pt": "Recursos e equipas",
        "ru": "Ресурсы и бригады",
        "zh": "资源与人员",
        "ja": "リソース・人員",
        "ko": "리소스 및 인력",
        "ar": "الموارد والطاقم",
        "hi": "संसाधन और दल",
        "th": "ทรัพยากรและทีมงาน",
        "vi": "Tài nguyên & đội ngũ",
        "id": "Sumber Daya & Tim",
        "tr": "Kaynaklar ve Ekip",
        "nl": "Middelen & personeel",
        "pl": "Zasoby i załoga",
        "cs": "Zdroje a personál",
        "sv": "Resurser & personal",
        "no": "Ressurser og mannskap",
        "da": "Ressourcer og mandskab",
        "fi": "Resurssit ja henkilöstö",
        "ro": "Resurse și echipe",
        "bg": "Ресурси и екипи",
        "hr": "Resursi i osoblje",
    },
    "nav.service": {
        "de": "Service & Wartung",
        "fr": "Service & maintenance",
        "es": "Servicio y mantenimiento",
        "it": "Servizio e manutenzione",
        "pt": "Serviço e manutenção",
        ...
        "da": "Service og vedligehold",
        "fi": "Huolto ja kunnossapito",
        "ro": "Service și mentenanță",
        "bg": "Сервиз и поддръжка",
        "hr": "Servis i održavanje",
    },
    "nav.portal": {
        "de": "Nachunternehmer-Portal",
        "fr": "Portail sous-traitants",
        "es": "Portal de subcontratistas",
        "it": "Portale subappaltatori",
        "pt": "Portal de subempreiteiros",
        "ru": "Портал субподрядчиков",
        "zh": "分包商门户",
        "ja": "下請業者ポータル",
        "ko": "협력업체 포털",
        "ar": "بوابة المقاولين الفرعيين",
        "hi": "उपठेकेदार पोर्टल",
        "th": "พอร์ทัลผู้รับเหมาช่วง",
        "vi": "Cổng nhà thầu phụ",
        "id": "Portal Subkontraktor",
        "tr": "Alt Yüklenici Portalı",
        "nl": "Onderaannemersportaal",
        "pl": "Portal podwykonawców",
        "cs": "Portál subdodavatelů",
        "sv": "Underentreprenörsportal",
        "no": "Underentreprenørportal",
        "da": "Underentreprenørportal",
        "fi": "Aliurakoitsijaportaali",
        "ro": "Portal subantreprenori",
        "bg": "Портал за подизпълнители",
    ...
    "nav.crm": {
        ...
        "ja": "CRM (顧客管理)",
        "ko": "CRM (고객 관리)",
        "ar": "إدارة العلاقات (CRM)",
        "hi": "CRM (ग्राहक प्रबंधन)",
        "th": "CRM (จัดการลูกค้า)",
        "vi": "CRM (Quản lý khách hàng)",
        "id": "CRM (Manajemen Pelanggan)",
        "tr": "CRM (Müşteri Yönetimi)",
        "nl": "CRM",
        "pl": "CRM",
        "cs": "CRM",
        "sv": "CRM",
    ...
    "nav.subcontractors": {
        ...
        "pl": "Podwykonawcy",
        "cs": "Subdodavatelé",
        "sv": "Underentreprenörer",
        "no": "Underentreprenører",
        "da": "Underentreprenører",
        "fi": "Aliurakoitsijat",
        "ro": "Subantreprenori",
        "bg": "Подизпълнители",
        "hr": "Podizvođači",
    ...
    "nav.bid_management": {
        ...
        "es": "Gestión de ofertas",
        "it": "Gestione offerte",
        "pt": "Gestão de propostas",
        "ru": "Управление тендерами",
        "zh": "投标管理",
        "ja": "入札管理",
        "ko": "입찰 관리",
        "ar": "إدارة العطاءات",
        ...
        "th": "การจัดการประมูล",
        "vi": "Quản lý đấu thầu",
        "id": "Manajemen Penawaran",
        "tr": "Teklif Yönetimi",
        "nl": "Offertebeheer",
        "pl": "Zarządzanie ofertami",
        "cs": "Správa nabídek",
        "sv": "Anbudshantering",
        "no": "Anbudsstyring",
        "da": "Tilbudsstyring",
        "fi": "Tarjoushallinta",
        "ro": "Managementul ofertelor",
        "bg": "Управление на оферти",
    ...
    "nav.variations": {
        ...
        "ar": "أوامر التغيير",
        "hi": "परिवर्तन आदेश",
        "th": "ใบสั่งเปลี่ยนแปลง",
        "vi": "Lệnh thay đổi",
        "id": "Variasi",
        "tr": "Değişiklik Emirleri",
        "nl": "Meerwerken",
        "pl": "Zmiany umowy",
        "cs": "Změnové listy",
        "sv": "Ändringsorder",
        ...
        "da": "Ændringsordrer",
        "fi": "Muutostyöt",
        "ro": "Modificări contract",
        "bg": "Анекси",
        "hr": "Izmjene ugovora",
    },
    "nav.supplier_catalogs": {
        "de": "Lieferantenkataloge",
        "fr": "Catalogues fournisseurs",
        "es": "Catálogos de proveedores",
        "it": "Cataloghi fornitori",
        "pt": "Catálogos de fornecedores",
        "ru": "Каталоги поставщиков",
        "zh": "供应商目录",
        "ja": "サプライヤーカタログ",
        "ko": "공급업체 카탈로그",
        "ar": "كتالوجات الموردين",
        "hi": "आपूर्तिकर्ता कैटलॉग",
        "th": "แคตตาล็อกซัพพลายเออร์",
        "vi": "Danh mục nhà cung cấp",
        "id": "Katalog Pemasok",
        "tr": "Tedarikçi Katalogları",
        "nl": "Leverancierscatalogi",
        "pl": "Katalogi dostawców",
        "cs": "Katalogy dodavatelů",
        "sv": "Leverantörskataloger",
        "no": "Leverandørkataloger",
        "da": "Leverandørkataloger",
        "fi": "Toimittajaluettelot",
        "ro": "Cataloage furnizori",
        "bg": "Каталози на доставчици",
    ...
    "nav.property_dev": {
        ...
        "pt": "Desenvolvimento imobiliário",
        "ru": "Девелопмент",
        "zh": "房地产开发",
        "ja": "不動産開発",
        "ko": "부동산 개발",
        "ar": "التطوير العقاري",
        "hi": "संपत्ति विकास",
        "th": "พัฒนาอสังหาริมทรัพย์",
        "vi": "Phát triển bất động sản",
        "id": "Pengembangan Properti",
        "tr": "Gayrimenkul Geliştirme",
        "nl": "Projectontwikkeling",
        "pl": "Deweloperka",
        "cs": "Developerství",
        "sv": "Fastighetsutveckling",
        "no": "Eiendomsutvikling",
        "da": "Ejendomsudvikling",
        "fi": "Kiinteistökehitys",
        "ro": "Dezvoltare imobiliară",
        "bg": "Девелопмънт",
        "hr": "Razvoj nekretnina",
    },
    "nav.schedule_advanced": {
        "de": "Erweiterter Terminplan",
        "fr": "Planning avancé",
        "es": "Cronograma avanzado",
        "it": "Pianificazione avanzata",
        "pt": "Cronograma avançado",
        "ru": "Расширенный график",
        "zh": "高级进度计划",
        "ja": "高度なスケジュール",
        "ko": "고급 일정",
        "ar": "جدول زمني متقدم",
        "hi": "उन्नत अनुसूची",
        "th": "ตารางเวลาขั้นสูง",
        "vi": "Lịch trình nâng cao",
        "id": "Jadwal Lanjutan",
        "tr": "Gelişmiş Zamanlama",
        "nl": "Geavanceerd schema",
        "pl": "Zaawansowany harmonogram",
        "cs": "Pokročilý harmonogram",
        "sv": "Avancerat schema",
        "no": "Avansert tidsplan",
        "da": "Avanceret tidsplan",
        "fi": "Edistynyt aikataulu",
        "ro": "Program avansat",
        "bg": "Разширен график",
    ...
    "nav.qms": {
        ...
        "cs": "Řízení kvality",
        "sv": "Kvalitetsstyrning",
        "no": "Kvalitetsstyring",
        "da": "Kvalitetsstyring",
        "fi": "Laadunhallinta",
        "ro": "Managementul calității",
        "bg": "Управление на качеството",
    ...
    "nav.match_elements": {
        "de": "Element-Abgleich → Kosten",
        "fr": "Correspondance éléments → coûts",
        "es": "Coincidir elementos → Costos",
        "it": "Abbina elementi → Costi",
        "pt": "Comparar elementos → Custos",
        "ru": "Сопоставить элементы → Цены",
        "zh": "元素匹配 → 成本",
        "ja": "要素マッチ → コスト",
        "ko": "요소 매칭 → 비용",
        "ar": "مطابقة العناصر → التكاليف",
        "hi": "तत्व मिलान → लागत",
        "th": "จับคู่องค์ประกอบ → ต้นทุน",
        "vi": "Khớp phần tử → Chi phí",
        "id": "Cocokkan Elemen → Biaya",
        "tr": "Eleman Eşleştirme → Maliyet",
        "nl": "Elementen koppelen → Kosten",
        "pl": "Dopasuj elementy → Koszty",
        "cs": "Spárovat prvky → Náklady",
        "sv": "Matcha element → Kostnader",
        "no": "Match elementer → Kostnader",
        "da": "Match elementer → Omkostninger",
        "fi": "Yhdistä elementit → Kustannukset",
        "ro": "Potrivire elemente → Costuri",
        "bg": "Съпоставяне на елементи → Цени",
        "hr": "Spoji elemente → Troškovi",
    },
    "nav.group_quality": {
        "de": "Qualität & Sicherheit",
        "fr": "Qualité & sécurité",
        "es": "Calidad y seguridad",
        "it": "Qualità e sicurezza",
        "pt": "Qualidade e segurança",
        "ru": "Качество и безопасность",
        "zh": "质量与安全",
        "ja": "品質・安全",
        "ko": "품질 및 안전",
        "ar": "الجودة والسلامة",
        "hi": "गुणवत्ता और सुरक्षा",
        "th": "คุณภาพและความปลอดภัย",
        "vi": "Chất lượng & an toàn",
        "id": "Kualitas & Keselamatan",
        "tr": "Kalite ve Güvenlik",
        "nl": "Kwaliteit & veiligheid",
        "pl": "Jakość i bezpieczeństwo",
        "cs": "Kvalita a bezpečnost",
        "sv": "Kvalitet & säkerhet",
        "no": "Kvalitet og sikkerhet",
        "da": "Kvalitet og sikkerhed",
        "fi": "Laatu ja turvallisuus",
        "ro": "Calitate și siguranță",
        "bg": "Качество и безопасност",
        "hr": "Kvaliteta i sigurnost",
    },
    "nav.group_operations": {
        "de": "Baustellenbetrieb",
        "fr": "Opérations chantier",
        "es": "Operaciones en obra",
        "it": "Operazioni di cantiere",
        "pt": "Operações de obra",
        "ru": "Операции на объекте",
        "zh": "现场运营",
        "ja": "現場運用",
        "ko": "현장 운영",
        "ar": "عمليات الموقع",
        "hi": "क्षेत्र संचालन",
        "th": "การปฏิบัติงานภาคสนาม",
        "vi": "Vận hành công trường",
        "id": "Operasi Lapangan",
        "tr": "Saha Operasyonları",
        "nl": "Bouwplaatsoperaties",
        "pl": "Operacje budowy",
        "cs": "Provoz stavby",
        "sv": "Platsdrift",
        "no": "Driftsoperasjoner",
        "da": "Pladsoperationer",
        "fi": "Työmaatoiminta",
        "ro": "Operațiuni de șantier",
        "bg": "Полеви операции",
