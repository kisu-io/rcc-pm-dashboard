...
TEMPLATE = DemoTemplate(
    ...
    project_description=(
        ...
        "Structure en béton armé (Eurocode 2) avec système primaire "
        ...
        "acoustiques NRA. Étages techniques interstitiels au-dessus des blocs "
        ...
        "EN ISO 7396-1, installation électrique a usage medical NFC 15-211 "
        ...
        "publique. Sécurité incendie type U (etablissement de soins) selon "
        "le reglement ERP. Coût de construction env. 118 M EUR en coûts "
        "directs (~150 M EUR avec frais de chantier, frais généraux, benefice "
    ...
    sections=[
        ...
        (
            ...
            [
                ...
                ("01.2", "Démolition existant et desamiantage (Démolition/asbestos removal)", "lsum", 1, 420000.00, {"dpgf": "01"}),
                ...
                ("01.5", "Pieux fores béton armé d=800mm (Bored RC piles)", "m", 5400, 165.00, {"dpgf": "01"}),
                ("01.6", "Rabattement de nappe phreatique (Dewatering)", "lsum", 1, 245000.00, {"dpgf": "01"}),
                ("01.7", "Radier general béton armé C30/37 ep. 700mm (Mat foundation)", "m3", 4350, 285.00, {"dpgf": "01"}),
                ("01.8", "Semelles, massifs et longrines béton armé (Footings/pile caps)", "m3", 1850, 295.00, {"dpgf": "01"}),
                ("01.9", "Étanchéité cuvelage sous-sol type C (Basement tanking)", "m2", 9800, 52.00, {"dpgf": "01"}),
                ("01.10", "Remblaiement, compactage et évacuation des terres (Backfill/soil disposal)", "m3", 48000, 24.00, {"dpgf": "01"}),
            ],
        ),
        # ── 02 Gros Oeuvre / Structure Beton (Concrete Superstructure) ───
        (
            "02",
            "Gros Oeuvre / Structure Béton (Concrete Superstructure)",
            {"dpgf": "02"},
            [
                ("02.1", "Voiles béton armé C35/45 contreventement (RC shear walls)", "m3", 8600, 345.00, {"dpgf": "02"}),
                ("02.2", "Poteaux béton armé C40/50 (RC columns)", "m3", 2400, 425.00, {"dpgf": "02"}),
                ("02.3", "Planchers-dalles béton armé C30/37 (RC flat slabs)", "m3", 11200, 295.00, {"dpgf": "02"}),
                ...
                ("02.6", "Poutres et longrines béton armé (RC beams/ground beams)", "m3", 2100, 350.00, {"dpgf": "02"}),
                ...
                ("02.10", "Maçonnerie agglomere béton et reservations techniques (Masonry/builders work)", "m2", 7800, 115.00, {"dpgf": "02"}),
            ],
        ),
        ...
        (
            ...
            {"dpgf": "03"},
            [
                ("03.1", "Charpente métallique heliport et plant rooms (Steel roof framing)", "t", 285, 4600.00, {"dpgf": "03"}),
                ...
                ("03.5", "Étanchéité membrane bi-couche autoprotegee (Bituminous roofing)", "m2", 6800, 62.00, {"dpgf": "03"}),
                ...
                ("03.9", "Releves, solins et évacuation eaux pluviales (Flashings/roof drainage)", "m", 1850, 62.00, {"dpgf": "03"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("04.6", "Portes d'entrée automatiques sas (Automatic entrance airlocks)", "pcs", 8, 18500.00, {"dpgf": "04"}),
                ("04.7", "Membrane d'étanchéité a l'air et isolation laine minerale (Air-barrier/insulation)", "m2", 21000, 56.00, {"dpgf": "04"}),
        ...
        (
            ...
            [
                ...
                ("05.7", "Cloisons vitrées coupe-feu circulations (Glazed fire screens)", "m2", 2800, 320.00, {"dpgf": "05"}),
        ...
        (
            ...
            [
                ...
                ("06.5", "Chaufferie gaz a condensation et sous-station réseau de chaleur (Boilers/DH sub-station)", "lsum", 1, 549000.00, {"dpgf": "06"}),
                ("06.6", "Réseau de gaines aerauliques tôle galvanisée (Galvanised ductwork)", "kg", 168000, 12.50, {"dpgf": "06"}),
                ...
                ("06.10", "Diffuseurs, grilles et clapets coupe-feu/coupe-fumée (Diffusers/dampers)", "pcs", 4200, 215.00, {"dpgf": "06"}),
                ("06.11", "GTB / régulation et supervision (BMS/DDC controls)", "lsum", 1, 1250000.00, {"dpgf": "06"}),
                ("06.12", "Équilibrage aeraulique et mise en service (Commissioning/TAB)", "lsum", 1, 285000.00, {"dpgf": "06"}),
            ],
        ),
        ...
        (
            ...
            {"dpgf": "08"},
            [
                ("08.1", "Réseau évacuation EU/EV fonte et PVC (Soil/waste drainage)", "m", 8600, 72.00, {"dpgf": "08"}),
                ("08.2", "Réseau alimentation eau froide/chaude multicouche (Domestic water piping)", "m", 11200, 58.00, {"dpgf": "08"}),
        ...
        (
            "09",
            "Électricité CFO/CFA et Sécurité (Electrical, IT & Life Safety)",
            {"dpgf": "09"},
            [
                ...
                ("09.6", "Chemins de câbles, câblage force et liaisons equipotentielles (Wiring/earthing)", "m", 185000, 10.80, {"dpgf": "09"}),
                ("09.7", "Luminaires LED dont salles de soins (LED luminaires incl. clinical)", "pcs", 14500, 165.00, {"dpgf": "09"}),
                ("09.8", "Éclairage operatoire scialytique (Surgical operating lights)", "pcs", 18, 28500.00, {"dpgf": "09"}),
                ("09.9", "Éclairage de sécurité BAES (Emergency/exit lighting)", "pcs", 2200, 145.00, {"dpgf": "09"}),
                ("09.10", "SSI catégorie A type U et desenfumage (Fire detection/smoke control)", "lsum", 1, 1070000.00, {"dpgf": "09"}),
                ("09.11", "Câblage VDI catégorie 6A (Structured cabling cat.6A)", "m", 145000, 4.80, {"dpgf": "09"}),
                ("09.12", "Appel malade et signalisation chambres (Nurse-call system)", "pcs", 320, 2850.00, {"dpgf": "09"}),
                ("09.13", "Contrôle d'accès, videosurveillance et GTC sécurité (Access control/CCTV)", "lsum", 1, 685000.00, {"dpgf": "09"}),
            ],
        ),
        # ── 10 Equipements Medicaux et Locaux Techniques (Medical Fit-out) ─
        (
            "10",
            "Équipements Medicaux et Locaux Techniques (Medical Rooms & Equipment)",
            {"dpgf": "10"},
            [
                ...
                ("10.8", "Chambres a flux d'air contrôle isolement (Isolation rooms ventilation)", "pcs", 24, 38500.00, {"dpgf": "10"}),
                ("10.9", "Tables d'operation et équipement de bloc (OR tables/equipment)", "pcs", 9, 95000.00, {"dpgf": "10"}),
        ...
        (
            ...
            {"dpgf": "11"},
            [
                ("11.1", "Chape liquide anhydrite et sol PVC hospitalier soudé (Screed + welded vinyl)", "m2", 28500, 82.00, {"dpgf": "11"}),
                ...
                ("11.6", "Faux plafonds coupe-feu et étanches bloc (Sealed/fire ceilings OR)", "m2", 4200, 145.00, {"dpgf": "11"}),
                ("11.7", "Peinture acrylique lessivable (Washable acrylic paint)", "m2", 96000, 12.50, {"dpgf": "11"}),
                ("11.8", "Menuiseries intérieures portes hospitalieres (Hospital door sets)", "pcs", 2400, 1250.00, {"dpgf": "11"}),
        ...
        (
            ...
            {"dpgf": "12"},
            [
                ("12.1", "Voirie lourde accès urgences et logistique (Heavy-duty roads)", "m2", 9800, 78.00, {"dpgf": "12"}),
                ("12.2", "Parvis et cheminements pietons béton desactive (Plaza/footpaths)", "m2", 6200, 95.00, {"dpgf": "12"}),
                ("12.3", "Réseaux humides EU/EP/AEP exterieurs (External wet utilities)", "m", 3400, 165.00, {"dpgf": "12"}),
                ("12.4", "Bassin de rétention et régulation pluviale (Stormwater rétention basin)", "lsum", 1, 385000.00, {"dpgf": "12"}),
                ("12.5", "Réseaux secs et raccordements concessionnaires (Dry utilities/connections)", "m", 2800, 95.00, {"dpgf": "12"}),
                ...
                ("12.9", "Éclairage extérieur LED sur mats et cloture site (External lighting/fencing)", "pcs", 145, 2200.00, {"dpgf": "12"}),
            ],
        ),
    ],
    markups=[
        ("Frais de chantier (FC)", 9.0, "overhead", "direct_cost"),
        ("Frais généraux (FG)", 12.0, "overhead", "direct_cost"),
        ("Benefice (Profit)", 5.0, "profit", "direct_cost"),
        ("Aleas et imprévus (Contingency)", 6.0, "contingency", "direct_cost"),
        ("TVA", 20.0, "tax", "cumulative"),
    ],
    total_months=32,
    tender_name="Lot Gros Oeuvre (Structural/Foundations)",
    tender_companies=[
        ("Maurenne Bâtiment Sud-Est", "appels@maurenne.example", 0.98),
    ...
    project_metadata={
        ...
        "storeys": 7,
        "basement_levels": 1,
        "structure_system": "Béton armé contrevente (Eurocode 2 / Eurocode 8)",
        "codes": [
            "Eurocode 2 (NF EN 1992) - structures en béton",
            ...
            "Reglement de sécurité incendie ERP - type U (etablissements de soins)",
        ],
        "permits": (
            "Permis de construire Ville de Lyon (ZAC Lyon Confluence); "
            "avis de la commission de sécurité ERP type U; autorisation "
            "ARS Auvergne-Rhone-Alpes; declaration ASN pour les installations "
            "de radiologie; dossier loi sur l'eau (bassin de rétention)."
        ),
        "sustainability": "Cible HQE Bâtiment Durable niveau Excellent; RE 2020 tertiaire",
        "seismic": "Eurocode 8 - Lyon zone de sismicite 3 (modere), catégorie d'importance IV",
        "taxes_note": (
            "TVA au taux normal de 20 % applicable en sus des coûts indiqués. "
            "Les positions sont exprimees en coûts directs hors taxes."
        ),
    },
    tender_packages=[
        (
            "Gros Oeuvre (Structural/Foundations)",
            "Terrassement, fondations profondes, béton armé parasismique, maçonnerie",
            "evaluating",
            [
                ("Maurenne Bâtiment Sud-Est", "appels@maurenne.example", 0.98),
                ("Ferlac Construction Rhone-Alpes", "marches@ferlac.example", 1.05),
        ...
        (
            ...
            "Mur-rideau, ITE, bardage, menuiseries exterieures, étanchéité, heliport",
            "evaluating",
            [
        ...
        (
            "Électricité CFO/CFA et Sécurité (Electrical & Life Safety)",
        ...
        (
            "Équipements Medicaux et Salles Propres (Medical Fit-out)",
        ...
        (
            ...
            "Voirie, réseaux humides et secs, bassin de rétention, espaces verts, helistation",
            "evaluating",
            [
    ...
    budget_boq_name="Centre Hospitalier Lyon Confluence - Budget de Contrôle",
