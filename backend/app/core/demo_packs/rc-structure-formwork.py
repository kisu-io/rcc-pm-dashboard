...
TEMPLATE = DemoTemplate(
    ...
    project_name="Parkhaus & Büro-Podium Stuttgart-Vaihingen",
    project_description=(
        "Neubau eines 7-geschossigen Stahlbeton-Parkhauses (Ortbeton) mit "
        "rund 612 Stellplätzen und einem zweigeschossigen Büro-/Einzelhandels-"
        "Podium im Erdgeschoss. BGF ca. 18.400 m2 Parkdeck zzgl. 2.100 m2 Podium. "
        "Tragwerk: Ortbeton-Flachdecken mit Unterzügen, Rundstützen und zwei "
        ...
        "Schalung ist kostenführend: Rahmenschalung Wände, Deckentische, "
        "Stützenschalung, Selbstkletterschalung Kerne, Traggerüste. "
        "Frischbetondruck nach DIN 18218, Traggerüste nach DIN EN 12812, "
        "Betonausführung DIN EN 13670 / VOB/C DIN 18331. "
    ...
    boq_description=(
        ...
        "Schalung, Traggerüste und Ortbeton. Mengen je Schalzyklus / Betonierabschnitt, "
    ...
    boq_metadata={
        ...
        "phase": "Kostenberechnung (LP 3) / Ausführungsplanung",
        "base_date": "2026-Q1",
    ...
    sections=[
        ...
        (
            ...
            [
                ...
                ("310.6", "Spritzbetonsicherung Böschung (Shotcrete slope)", "m2", 720, 62.00, {"din276": "310"}),
                ("310.7", "Wasserhaltung offene + Brunnen (Dewatering)", "month", 14, 9800.00, {"din276": "310"}),
                ("310.8", "Verfüllung / Hinterfüllung lagenweise (Backfill)", "m3", 2600, 17.20, {"din276": "310"}),
                ("310.9", "Verdichtung Planum Ev2>=45 MN/m2 (Subgrade compaction)", "m2", 5400, 5.20, {"din276": "310"}),
                ("310.10", "Baustraße Schottertragschicht 0/45 (Haul road)", "m2", 1200, 29.50, {"din276": "310"}),
            ],
        ),
        # ── KG 322 Flachgruendungen / Bodenplatte ─────────────────────
        (
            "322",
            "KG 322 - Flachgründungen / Bodenplatte",
            {"din276": "322"},
            [
                ...
                ("322.3", "Einzelfundamente Stützen C30/37 (Column pad footings)", "m3", 480, 168.00, {"din276": "322"}),
                ...
                ("322.10", "Perimeterdämmung XPS 120mm (Perimeter insulation)", "m2", 1450, 46.00, {"din276": "322"}),
            ],
        ),
        # ── KG 331 Tragende Aussenwaende - Schalung & Beton ──────────
        (
            "331",
            "KG 331 - Tragende Außenwände (Schalung/Beton)",
            {"din276": "331"},
            [
                ("331.1", "Schalung Außenwand Rahmenschalung 25cm, beidseitig (Wall framed formwork)", "m2", 9200, 33.50, {"din276": "331"}),
                ...
                ("331.4", "Stahlbeton Außenwand C30/37, d=25cm, XC4/XF4 (RC external wall)", "m3", 1150, 152.00, {"din276": "331"}),
                ("331.5", "Bewehrung Außenwände BSt 500 B, ~95 kg/m3 (Wall reinforcement)", "t", 109, 1520.00, {"din276": "331"}),
                ("331.6", "Aussparungen / Kastenaussparungen Wand (Wall box-outs)", "pcs", 180, 48.00, {"din276": "331"}),
                ("331.7", "Betoniergerüst / Arbeitsbühne Wand (Wall working platform)", "m2", 2300, 18.50, {"din276": "331"}),
                ("331.8", "Brüstungen Parkdeck Ortbeton h=1,10m (RC parapet upstands)", "m3", 320, 198.00, {"din276": "331"}),
                ("331.9", "Schalung Brüstungen beidseitig (Parapet formwork)", "m2", 5800, 36.00, {"din276": "331"}),
        ...
        (
            "333",
            "KG 333 - Außenstützen (Schalung/Beton)",
            {"din276": "333"},
            [
                ("333.1", "Stützenschalung Rundstütze d=40cm, Kartonschalung (Round column formwork)", "m2", 1180, 52.00, {"din276": "333"}),
                ("333.2", "Stützenschalung Rechteck 40x40, Stützenklappschalung (Rect. column formwork)", "m2", 860, 44.00, {"din276": "333"}),
                ("333.3", "Stahlbeton Stützen C45/55, XC4/XD3 (RC columns high-grade)", "m3", 410, 218.00, {"din276": "333"}),
                ("333.4", "Bewehrung Stützen BSt 500 B, ~220 kg/m3 (Column reinforcement)", "t", 90, 1620.00, {"din276": "333"}),
                ("333.5", "Stützenfüße / Schwertanschluss (Column base fixings)", "pcs", 168, 95.00, {"din276": "333"}),
                ("333.6", "Anprallschutz Stützen Stahl (Column impact protection)", "pcs", 168, 280.00, {"din276": "333"}),
                ("333.7", "Stützenkopf-Verstärkung / Pilzkopf Schalung (Column head drop formwork)", "pcs", 84, 145.00, {"din276": "333"}),
            ],
        ),
        # ── KG 341 Tragende Innenwaende / Kerne - Kletterschalung ────
        (
            "341",
            "KG 341 - Tragende Innenwände / Kerne (Kletterschalung)",
            {"din276": "341"},
            [
                ("341.1", "Selbstkletterschalung Kerne SKE, Auf-/Abbau + Vorhaltung (Self-climbing formwork cores)", "m2", 3600, 78.00, {"din276": "341"}),
                ("341.2", "Schalung Innenwände Trägerschalung, d=30cm (Girder wall formwork)", "m2", 6400, 31.50, {"din276": "341"}),
                ("341.3", "Stahlbeton Kernwände C35/45, d=30cm (RC core walls)", "m3", 980, 162.00, {"din276": "341"}),
                ("341.4", "Stahlbeton Innenwände C30/37, d=25cm (RC internal walls)", "m3", 640, 150.00, {"din276": "341"}),
                ("341.5", "Bewehrung Kerne + Innenwände BSt 500 B, ~110 kg/m3 (Reinforcement)", "t", 178, 1520.00, {"din276": "341"}),
                ("341.6", "Klettergerüst / Klettersteg Absturzsicherung DGUV 101-008 (Climbing access / edge prot.)", "m2", 1200, 28.00, {"din276": "341"}),
                ("341.7", "Aussparungen Kern Türen/Schächte (Core openings doors/shafts)", "pcs", 96, 88.00, {"din276": "341"}),
        ...
        (
            ...
            [
                ...
                ("351.2", "Deckenschalung Trägerschalung Rand-/Restflächen (Beam-girder slab formwork)", "m2", 4800, 34.00, {"din276": "351"}),
                ...
                ("351.5", "Unterzüge Ortbeton C35/45 b/h=40/70 (RC downstand beams)", "m3", 720, 175.00, {"din276": "351"}),
                ("351.6", "Schalung Unterzüge dreiseitig (Beam formwork three-sided)", "m2", 5400, 38.00, {"din276": "351"}),
                ("351.7", "Durchstanzbewehrung Dübelleisten Stützen (Punching shear rails)", "pcs", 168, 320.00, {"din276": "351"}),
                ("351.8", "Aussparungen Decke / Schalungskörper (Slab penetrations / formers)", "pcs", 420, 42.00, {"din276": "351"}),
                ...
                ("351.11", "Gefälleestrich Parkdeck im Verbund 1,5% (Bonded fall screed)", "m2", 17800, 26.00, {"din276": "351"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("352.5", "Trennmittel / Schalungsöl umweltverträglich (Release agent)", "l", 6800, 4.80, {"din276": "352"}),
                ...
                ("352.8", "Mietgerüst Fassadengerüst Last-/Schutzklasse (Facade scaffold rental)", "m2", 6400, 14.50, {"din276": "352"}),
            ],
        ),
        ...
        (
            ...
            [
                ...
                ("359.4", "Elastomerlager Unterzug/Stütze (Elastomeric bearings)", "pcs", 96, 285.00, {"din276": "359"}),
                ("359.5", "Brandschutzbeschichtung exponierte Bewehrung (Fire coating to exposed rebar)", "m2", 1200, 38.00, {"din276": "359"}),
                ("359.6", "Probekörper / Würfeldruckprüfung DIN EN 12390 (Cube test specimens)", "pcs", 360, 28.00, {"din276": "359"}),
        ...
        (
            ...
            [
                ...
                ("363.4", "OS 11 rissüberbrückende Beschichtung Parkdeck (OS-11 deck coating)", "m2", 2900, 58.00, {"din276": "363"}),
                ("363.5", "Gefälledämmung / Entwässerung oberstes Deck (Falls + drainage)", "m2", 2900, 34.00, {"din276": "363"}),
        ...
        (
            ...
            [
                ...
                ("371.3", "Schalung Rampen gekrümmt (Curved ramp formwork)", "m2", 2200, 56.00, {"din276": "371"}),
        ...
        (
            "379",
            "KG 379 - Fertigteil-Ergänzungen",
            {"din276": "379"},
            [
                ("379.1", "Fertigteil-Stützen UG ergänzend (Precast columns basement)", "pcs", 48, 1450.00, {"din276": "379"}),
                ("379.2", "Fertigteil-Treppenläufe (Precast stair flights)", "pcs", 28, 2400.00, {"din276": "379"}),
                ("379.3", "Halbfertigteildecken Filigran Restflächen (Filigree slab elements)", "m2", 1800, 64.00, {"din276": "379"}),
        ...
        (
            "411",
            "KG 411 - Entwässerung Parkdeck",
            {"din276": "411"},
            [
                ("411.1", "Bodenabläufe Parkdeck Edelstahl DN100 (SS deck gullies)", "pcs", 96, 320.00, {"din276": "411"}),
                ("411.2", "Entwässerungsleitung Gusseisen SML DN150 (Cast-iron drainage)", "m", 1400, 62.00, {"din276": "411"}),
                ("411.3", "Leichtflüssigkeitsabscheider Klasse I (Oil separator class I)", "pcs", 2, 18500.00, {"din276": "411"}),
        ...
        (
            ...
            [
                ...
                ("443.4", "Äußere Blitzschutzanlage Parkhaus (External lightning protection)", "lsum", 1, 32000.00, {"din276": "443"}),
            ],
        ),
        # ── KG 538 Aussenanlagen / Baustelleneinrichtung ─────────────
        (
            "538",
            "KG 538 - Baustelleneinrichtung / Außenanlagen Konstruktion",
            {"din276": "538"},
            [
                ("538.1", "Turmdrehkran 60m, Vorhaltung + Betrieb (Tower crane standing + operation)", "month", 15, 16500.00, {"din276": "538"}),
                ("538.2", "Krangründung / Kranfundament Ortbeton (Crane foundation)", "pcs", 2, 24000.00, {"din276": "538"}),
                ...
                ("538.5", "Asphalt Zufahrt / Stellplätze Außen (External asphalt access)", "m2", 1800, 46.00, {"din276": "538"}),
    ...
    tender_companies=[
        ("Velbrand Schalungstechnik GmbH", "vergabe@velbrand.example", 0.99),
        ("Wehrsen & Talbrunn Hoch- und Industriebau GmbH", "angebot@wehrsen-talbrunn.example", 1.03),
        ("Konrad Halbfeld GmbH & Co. KG", "rohbau@halbfeld.example", 1.01),
        ("Gottfried Marbeck GmbH & Co. KG", "kalkulation@marbeck.example", 1.06),
    ],
    project_metadata={
        "address": "Industriestraße 12, 70563 Stuttgart-Vaihingen",
        "client": "Tallwerk Parkraum- und Immobilien GmbH",
        "architect": "Rendel Architekten",
        "structural_engineer": "Vahlbrecht und Partner Tragwerksplanung",
        "gfa_m2": 20500,
        "parking_spaces": 612,
        "storeys": 7,
        "structure_system": "Ortbeton-Flachdecke mit Unterzügen, Rundstützen, 2 SB-Kerne (Gleitschalung)",
        "concrete_grades": "C30/37 - C45/55",
        "exposure_classes": "XC4, XD3, XF4 (Streusalzbelastung)",
        "reinforcement": "BSt 500 B / 500 S (DIN 488)",
        "formwork_systems": "Rahmenschalung, Trägerschalung, Deckentische, Stützenschalung, Selbstkletterschalung",
        ...
        "permit_note": "Baugenehmigung Stadt Stuttgart, Baurechtsamt; Prüfstatik durch Prüfingenieur für Baustatik (PIB)",
    ...
    tender_packages=[
        (
            ...
            "Schalung, Traggerüste, Bewehrung und Ortbeton - Bodenplatte bis oberstes Parkdeck",
            "evaluating",
            [
                ("Velbrand Schalungstechnik GmbH", "vergabe@velbrand.example", 0.99),
                ("Wehrsen & Talbrunn Hoch- und Industriebau GmbH", "angebot@wehrsen-talbrunn.example", 1.03),
